...
public class CueEvent_MyButtonChangeEnabled : CueEventBase
{
    ...
    public override string EventName
    {
        get
        {
            return "Change mybutton enabled";
        }
    }
    ...
    {
        GetComponent<MyButton>().buttonEnabled = (bool)param;
    }
}
