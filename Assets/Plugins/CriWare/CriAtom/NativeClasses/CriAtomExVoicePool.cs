...
public class CriAtomExVoicePool
{
	...
	{
        /* 機種共通のボイスプールID */
#if UNITY_EDITOR || UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_ANDROID || UNITY_IOS || UNITY_TVOS || UNITY_PS3 || UNITY_PS4 || UNITY_WINRT || UNITY_XBOXONE || UNITY_WEBGL || UNITY_SWITCH || UNITY_STANDALONE_LINUX
        ...
        /* 機種固有のボイスプールID */
#if UNITY_EDITOR || UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX || UNITY_IOS || UNITY_TVOS || UNITY_PS3 || UNITY_WINRT || UNITY_XBOXONE || UNITY_WEBGL || UNITY_SWITCH || UNITY_STANDALONE_LINUX
#elif UNITY_ANDROID
		...
		Audio3dMemory			= 8,								/**< [PS4] Audio3Dメモリ再生ボイスプールID */	
		Audio3dStreaming		= 9,								/**< [PS4] Audio3Dストリーミング再生ボイスプールID */
#else
#error unsupported platform
#endif
    }
